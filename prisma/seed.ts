...
async function main() {
  ...
  // Create sample questions (we'll create 150 for testing)
  let questionIndex = 0;
  for (let i = 0; i < 110; i++) {
    ...
    await prisma.question.create({
      data: {
        ...
        questionText: `Part I Question ${i + 1}: What is the correct answer?`,
        optionA: "Option A",
        optionB: "Option B",
        optionC: "Option C",
        optionD: "Option D",
        correctAnswer: [AnswerOption.A, AnswerOption.B, AnswerOption.C, AnswerOption.D][i % 4],
  ...
  for (let i = 0; i < 40; i++) {
    ...
    await prisma.question.create({
      data: {
        ...
        sectionId: partII.id,
        topicId: topics[topicIndex].id,
        questionText: `Part II Question ${i + 1}: What is the correct answer?`,
        optionA: "Option A",
        optionB: "Option B",
        optionC: "Option C",
        optionD: "Option D",
  ...
  console.log("Admin: admin@phillip.com / Admin@123");
  console.log("Student: student@phillip.com / Student@123");
}
