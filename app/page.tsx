...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
            ...
            {[
              {
                ...
                a: "Our AI is trained on thousands of exam results and correlates performance with official study guides. Accuracy improves as you complete more exams.",
              },
              {
                q: "What if I fail the exam?",
                a: "You can retake immediately. We'll recommend specific topics to review based on incorrect answers.",
              },
              {
                q: "How many practice questions are available?",
                a: "Each exam paper has 50-200+ questions depending on the module, with new questions added regularly.",
              },
              {
                q: "Is there technical support?",
                a: "Yes! Email support@phillipexamcoach.com or reach out via the in-app help widget.",
              },
            ].map((item, idx) => (
              <details key={idx} className="p-4 bg-slate-50 rounded-lg group">
      ...
      {/* Lead Capture */}
      <section id="start" className="py-20 bg-gradient-to-br from-blue-700 to-indigo-700">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <form
            onSubmit={(e) => {
              ...
              alert(
                `Welcome ${formData.get("name")}! Check your email for next steps.`
              );
            }}
          ...
          >
            <input
              ...
              required
              className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-700"
            />
            <input
              type="email"
              name="email"
            ...
            >
              ...
              <option value="RES-1A">RES-1A - Rules, Ethics and Skills</option>
              <option value="RES-5">RES-5 - Financial Advisory Services</option>
              <option value="CM-SIP">CM-SIP - Capital Markets</option>
              <option value="CM-LIP">CM-LIP - Life Insurance</option>
              <option value="HI">HI - Health Insurance</option>
